...
// not enough: this is what the resident can actually read first.
//
// DUPLICATE OF web/src/lib/privacy.js. Mobile cannot import from web/src
// (see AGENTS.md), so the two copies must be kept in sync by hand.
