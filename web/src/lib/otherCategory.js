...
// staff. Mirror of mobile/src/lib/otherCategory.js - the two apps share no
// package, so the parallel copies here and there follow the same pattern as
// reports.js. Keep them in step.
//
...
//
// The mobile copy carries the unit tests (web has no test runner).
...
export const OTHER_DETAIL_MAX = 100;
 ...
 */
export function withOtherDetail(description, specify) {
